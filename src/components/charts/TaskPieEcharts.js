...
class TaskPieEcharts extends Component {
    state={
        data:[],
    }
    componentDidMount() {
        axios.post('/api/worktt/task/getTrackCount.action')
            .then((response)=>{
                let data=[];
    ...
    render() {
        return (
            <div id="main04" style={{width: 510, height: 350, padding: 40}}/>
        );
    }
}
export default TaskPieEcharts;
